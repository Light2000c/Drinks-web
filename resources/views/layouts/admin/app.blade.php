...
<head>
    ...
    <link rel="apple-touch-icon" href="/web2/app-assets/images/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon" href="/web2/app-assets/images/ico/favicon.ico">
    <link
        href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i%7CQuicksand:300,400,500,700"
        rel="stylesheet">

    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css" href="/web2/app-assets/vendors/css/vendors.min.css">
    <link rel="stylesheet" type="text/css" href="/web2/app-assets/vendors/css/weather-icons/climacons.min.css">
    <link rel="stylesheet" type="text/css" href="/web2/app-assets/fonts/meteocons/style.min.css">
    <link rel="stylesheet" type="text/css" href="/web2/app-assets/vendors/css/charts/morris.css">
    <link rel="stylesheet" type="text/css" href="/web2/app-assets/vendors/css/charts/chartist.css">
    <link rel="stylesheet" type="text/css" href="/web2/app-assets/vendors/css/charts/chartist-plugin-tooltip.css">
    <!-- END: Vendor CSS-->

    <!-- BEGIN: Theme CSS-->
    <link rel="stylesheet" type="text/css" href="/web2/app-assets/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="/web2/app-assets/css/bootstrap-extended.min.css">
    <link rel="stylesheet" type="text/css" href="/web2/app-assets/css/colors.min.css">
    <link rel="stylesheet" type="text/css" href="/web2/app-assets/css/components.min.css">
    <!-- END: Theme CSS-->

    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="/web2/app-assets/css/core/menu/menu-types/vertical-menu-modern.css">
    <link rel="stylesheet" type="text/css" href="/web2/app-assets/css/core/colors/palette-gradient.min.css">
    <link rel="stylesheet" type="text/css" href="/web2/app-assets/fonts/simple-line-icons/style.min.css">
    <link rel="stylesheet" type="text/css" href="/web2/app-assets/css/core/colors/palette-gradient.min.css">
    <link rel="stylesheet" type="text/css" href="/web2/app-assets/css/pages/timeline.min.css">
    <link rel="stylesheet" type="text/css" href="/web2/app-assets/css/pages/dashboard-ecommerce.min.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern 2-columns   fixed-navbar" data-open="click"
            ...
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item mr-auto"><a class="navbar-brand" href="index.html"><img class="brand-logo"
                                alt="modern admin logo" src="/web2/app-assets/images/logo/logo.png">
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="active"><a href="{{ route('admin-dashboard') }}"><i class="fa fa-home"></i><span class="menu-title"
                            data-i18n="eCommerce Dashboard">Dashboard</span></a>
                </li>
                <li class=" navigation-header"><span data-i18n="Ecommerce">Product</span><i class="la la-ellipsis-h"
                        data-toggle="tooltip" data-placement="right" data-original-title="Ecommerce"></i>
                </li>
                <li class=" nav-item"><a href="{{ route('admin-product') }}"><i class="fa fa-shopping-bag"></i><span
                            class="menu-title" data-i18n="Shop">Product</span></a>
                </li>
                <li class=" nav-item"><a href="{{ route('admin-cart') }}"><i class="fa fa-shopping-cart"></i><span
                            class="menu-title" data-i18n="Product Detail">Cart</span></a>
                </li>
                ...
                <li class=" navigation-header"><span data-i18n="User Interface">User</span><i
                        class="la la-ellipsis-h" data-toggle="tooltip" data-placement="right"
                        data-original-title="User Interface"></i>
                </li>
                <li class=" nav-item"><a href="{{ route('admin-account') }}"><i class="fa fa-user"></i><span
                            class="menu-title" data-i18n="Order">Account</span></a>
                </li>
                <li class=" nav-item"><a href="{{ route('admin-team-member') }}"><i class="fa fa-users"></i><span
                            class="menu-title" data-i18n="Order">Team Member</span></a>
                </li>
                <li class=" navigation-header"><span data-i18n="User Interface">Auth</span><i
                        class="la la-ellipsis-h" data-toggle="tooltip" data-placement="right"
                        data-original-title="User Interface"></i>
                </li>
                <li class=" nav-item"><a href="{{ route('admin-setting') }}"><i class="fa fa-gear"></i><span
                            class="menu-title" data-i18n="Order">Settings</span></a>
                </li>
                <li class=" nav-item"><a href=""><i class="fa fa-sign-out"></i><span
    ...
    <!-- BEGIN: Vendor JS-->
    <script src="/web2/app-assets/vendors/js/vendors.min.js"></script>
    <!-- BEGIN Vendor JS-->

    <!-- BEGIN: Page Vendor JS-->
    <script src="/web2/app-assets/vendors/js/charts/chartist.min.js"></script>
    <script src="/web2/app-assets/vendors/js/charts/chartist-plugin-tooltip.min.js"></script>
    <script src="/web2/app-assets/vendors/js/charts/raphael-min.js"></script>
    <script src="/web2/app-assets/vendors/js/charts/morris.min.js"></script>
    <script src="/web2/app-assets/vendors/js/timeline/horizontal-timeline.js"></script>
    <!-- END: Page Vendor JS-->

    <!-- BEGIN: Theme JS-->
    <script src="/web2/app-assets/js/core/app-menu.min.js"></script>
    <script src="/web2/app-assets/js/core/app.min.js"></script>
    <script src="/web2/app-assets/js/scripts/customizer.min.js"></script>
    <script src="/web2/app-assets/js/scripts/footer.min.js"></script>
    <!-- END: Theme JS-->

    <!-- BEGIN: Page JS-->
    <script src="/web2/app-assets/js/scripts/pages/dashboard-ecommerce.min.js"></script>
    <!-- END: Page JS-->

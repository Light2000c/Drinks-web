...
Route::post('/search', [SearchController::class, 'search'])->name('search-product');
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('profile/wishlist/{product}', [ProfileWishlistController::class, 'store'])->name('add-wishes');
    Route::delete('profile/wishlist/{product}', [ProfileWishlistController::class, 'delete'])->name('delete-wishes');
...
Route::middleware(['is_admin'])->group(function () {
    ...
    Route::delete('/admin/accounts/{user}', [AccountController::class, 'destroy'])->name('admin-delete-account');

    Route::get('/admin/team-members', [TeamMemberController::class, 'index'])->name('admin-team-member');
    Route::post('/admin/team-members', [TeamMemberController::class, 'store'])->name('admin-team-member');

    Route::get('/admin/wishlists', [WishlistController::class, 'index'])->name('admin-wishlist');
    Route::delete('/admin/wishlists/{wish}', [WishlistController::class, 'destroy'])->name('admin-delete-wishes');
